...
export type CompanyStatus = "active" | "notActive" | "pending" | "suspended";
...
export const getCompanies = (init?: RequestInit) => {
    return sendRequest<CompanyType[]>(buildUrl("companies"), init);
};

export const getCompany = (id: string, init?: RequestInit) => {
    return sendRequest<CompanyType>(buildUrl("companies", id), init);
};

export const getPromotions = async (params: Record<string, string> = {}, init?: RequestInit) => {
    return sendRequest<PromotionType[]>(`${buildUrl("promotions")}?${stringifyQueryParams(params)}`, init);
};

export const createCompany = async (data: Omit<CompanyType, "id" | "hasPromotions">, init?: RequestInit) => {
    return sendRequest<CompanyType>(buildUrl("companies"), {
        ...init,
        method: "POST",
...
export const createPromotion = async (data: Omit<PromotionType, "id">, init?: RequestInit) => {
