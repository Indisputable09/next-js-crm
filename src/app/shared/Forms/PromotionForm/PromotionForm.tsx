...
import { createPromotion, getCompany, PromotionType } from "@/lib/api";
...
export const PromotionForm = ({ companyId, onSubmit }: PromotionFormProps) => {
    ...
    const { mutateAsync, isPending } = useMutation({
        mutationFn: async (data: Omit<PromotionType, "id">) => createPromotion(data),
        onSuccess: () => {
